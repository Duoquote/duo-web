export type QualityPreset = "quality" | "balanced" | "small" | "pixel";
...
const PRESET_MAP: Record<string, Record<QualityPreset, PresetValues>> = {
  libx264: {
    ...
    pixel: { crf: 51, videoBitrate: "200k", audioBitrate: "32k" },
  },
  libx265: {
  ...
  libvpx: {
    ...
    pixel: { crf: 63, videoBitrate: "200k", audioBitrate: "32k" },
  },
  "libvpx-vp9": {
  ...
  libmp3lame: {
    ...
    pixel: { crf: 0, videoBitrate: "0", audioBitrate: "32k" },
  },
  aac: {
  ...
  pcm_s16le: {
    ...
    pixel: { crf: 0, videoBitrate: "0", audioBitrate: "0" },
  },
  flac: {
    quality: { crf: 0, videoBitrate: "0", audioBitrate: "0" },
    balanced: { crf: 0, videoBitrate: "0", audioBitrate: "0" },
